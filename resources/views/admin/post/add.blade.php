...
<script>
    var fill_required_data_msg = '{{ __("fill_required_data_msg") }}';
</script>
@endsection

@section("content")

    @include("admin.post.loader")

    <div class="w3-row" v-bind:style="'height: '+(height - 70) +'px'" >
        <!-- sidebar  -->
        <div class="w3-col l3  w3-hide-small w3-hide-medium hidden" style="padding: 0px;padding-right: 5px" v-bind:style="'height: '+(height - 70) +'px'"  >
            <div class="shadow w3-white" style="height: 100%" >
                <br>
                <br>
                <center>
                    <b class="text-uppercase w3-xlarge w3-text-gray" >{{ __('create_post') }}</b>
                </center>
                <br>
                ...
                <div class="w3-large text-center" >
                    <b class="sidbar-title w3-text-gray" >{{ __('add_master_photo') }}</b>
                </div>
                <div class="text-gray text-center w3-padding" >
                    {{ __('please_add_one_photo') }}
                </div>
                <center>
                    <br>
                    <br>
                    <div style="width: 40%;height: 2px" class="w3-border-bottom w3-border-gray" ></div>
                    <div><a href="#" class="w3-text-gray" >{{ __('for_help_click_here') }}</a></div>
                </center>
            </div>
        </div>

        <div class="w3-col l12 nicescroll" >
            <center>
                <b class="text-uppercase w3-xlarge w3-text-gray" >{{ __('create_post') }}</b>
            </center>
            <br>
                    ...
                    <div style="padding: 30px"  >
                        ...
                        style="cursor: pointer;min-height: 400px;margin: auto;width: 80%;border: 2px dashed gray;padding: 30px;background-size: 100% 100%" >
                            ...
                            <center onclick="$('#masterImageInput').click()">
                                ...
                                <br>
                                <div class="w3-large text-gray" id="masterStatus" >{{ __("upload_photo_or_just_drag_and_drop") }}</div>
                            </center>
                ...
                <div class="w3-xxlarge w3-text-gray" >
                            ...
                            <div id="otherDrop360" class="drop w3-light-gray w3-round w3-block" style="cursor: pointer;height: 220px;border: 2px dashed gray;padding: 30px" >
                                ...
                                <center onclick="$('#otherImageInput360').click()">
                                    ...
                                    <div class="w3-large text-gray" id="status" >
                                        ...
                                        {{ __("upload_360_photo_or_just_drag_and_drop") }}
                                    </div>
                                </center>
                        ...
                        <div class="w3-col l6 m6 s6" >
                            <div id="otherDrop" class="drop w3-light-gray w3-round w3-block" style="cursor: pointer;height: 220px;border: 2px dashed gray;padding: 30px" >
                                ...
                                <center onclick="$('#otherImageInput').click()">
                                    ...
                                    <br>
                                    <div class="w3-large text-gray" id="status" >{{ __("upload_photo_or_just_drag_and_drop") }}</div>
                                </center>
                    ...
                    <center>
                        <button
                            class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInRight fa fa-angle-right"
                            style="width: 200px;border: 1px solid #02A2A7;"
                            onclick="gotoStep(4)" > {{ __("next") }} </button>
                        <button
                            class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInLeft fa fa-angle-left"
                            style="width: 200px;border: 1px solid #02A2A7;"
                ...
                <div class="w3-xxlarge w3-text-gray" >
                    ...
                    <div style="margin-top: 7px" id="otherDrop2"  >
                        <div class="drop w3-light-gray w3-round" style="cursor: pointer;min-height: 20px;border: 2px dashed gray;padding: 5px" >
                            ...
                            <div onclick="$('#otherImageInput').click()">
                                ...
                                <span class="w3-margin-left w3-large text-gray" id="status" >{{ __("upload_photo_or_just_drag_and_drop") }}</span>
                            </div>
                    ...
                    <center>
                        <button
                            class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInRight fa fa-angle-right"
                            style="width: 200px;border: 1px solid #02A2A7;"
                            onclick="gotoStep(5)" > {{ __("next") }} </button>
                        <button
                            class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInLeft fa fa-angle-left"
                            style="width: 200px;border: 1px solid #02A2A7;"
            ...
            <div class="w3-padding step step-5" id="postImageview" style="display: none" >
                <div class="w3-text-gray" >
                    <span class="w3-xxlarge" >{{ __("real_estate_details") }}</span>
                    <br>
                    <div style="width: 95%;height: 3px;margin-top: 5px" class="w3-border-bottom w3-border-gray" ></div>
                    <br>
                    ...
                    <div class="w3-block w3-white shadow w3-round w3-padding" style="margin-top: 7px;overflow: auto" >
                        ...
                        <div class="post-data-step post-data-step-1" >
                            <table class="w3-table w3-padding " >
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control input-sm" v-model="post.title"  placeholder="{{ __('title') }}">
                                    </td>
                                    <td>
                                        {{ __('title_ar') }} *
                                    </td>
                                    <td>
                                        <input type="text" class="form-control input-sm" v-model="post.title_ar"  placeholder="{{ __('title_ar') }}">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <select class="form-control w3-round input-sm" v-model="post.type"  onchange="setType(this.value)"  >
                                            <option value="sale" >{{ __('sell') }}</option>
                                            <option value="rent" >{{ __('rent') }}</option>
                                        </select>
                                    </td>
                                    <td>{{ __('space') }} *</td>
                                    <td>
                                         <input type="number" min="1"  class="form-control input-sm" v-model="post.space"  placeholder="{{ __('space') }}">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="category_hidden_2">{{ __('bedroom_number') }} *</td>
                                    <td class="category_hidden_2">
                                         <input type="number" min="0"  class="form-control input-sm" v-model="post.bedroom_number"  placeholder="{{ __('bedroom_number') }}">
                                    </td>
                                    <td class="category_hidden_2">{{ __('bathroom_number') }} *</td>
                                    <td class="category_hidden_2">
                                         <input type="number" min="0"  class="form-control input-sm" v-model="post.bathroom_number"  placeholder="{{ __('bathroom_number') }}">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="sale_type" >{{ __('price_per_meter') }} *</td>
                                    <td class="sale_type">
                                         <input type="number" min="1"  class="form-control input-sm" v-model="post.price_per_meter"  placeholder="{{ __('price_per_meter') }}">
                                    </td>
                                    <td>
                                        <span class='sale_type' >{{ __('price') }} *</span>
                                        <span class='rent_type' style="display: none" >{{ __('price_per_month') }}</span>
                                    </td>
                                    <td>
                                         <input type="number" min="0"  class="form-control input-sm" v-model="post.price"  placeholder="{{ __('price') }}">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>{{ __('build_date') }}</td>
                                    <td>
                                         <input type="date"  class="form-control input-sm" v-model="post.build_date"  placeholder="{{ __('build_date') }}">
                                    </td>
                                </tr>
                            </table>
                            <center>
                                <button
                                    class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInRight fa fa-angle-right"
                                    style="width: 200px;border: 1px solid #02A2A7;"
                                    onclick="gotoStep2(2)" > {{ __("next") }} </button>
                                <button
                                    class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInLeft fa fa-angle-left"
                                    style="width: 200px;border: 1px solid #02A2A7;"
                                    onclick="gotoStep(4)" > {{ __("back") }} </button>
                            </center>
                        </div>
                        ...
                        <div class="post-data-step post-data-step-2" >
                            ...
                            <center>
                                <button
                                    class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInRight fa fa-angle-right"
                                    style="width: 200px;border: 1px solid #02A2A7;"
                                    onclick="gotoStep2(3)" > {{ __("next") }} </button>
                                <button
                                    class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInLeft fa fa-angle-left"
                                    style="width: 200px;border: 1px solid #02A2A7;"
                                    onclick="gotoStep2(1)" > {{ __("back") }} </button>
                            </center>
                        ...
                        <table class="w3-table w3-padding " >
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radio w3-cell" onclick="app.post.payment_method='cash'" >
                                        ...
                                        <label  for="cash" class="radio-label">{{ __('cash') }}</label>
                                    </div>
                                    <div class="radio w3-cell" onclick="app.post.payment_method='installment'" >
                                        <input  id="installment" name="payment_method" type="radio">
                                        <label  for="installment" class="radio-label">{{ __('installment') }}</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="category_hidden_1" >{{ __('floor_number') }}</td>
                                <td class="category_hidden_1">
                                     <input type="number" class="form-control input-sm" v-model="post.floor_number" min="0"  placeholder="{{ __('floor_number') }}">
                                </td>
                                <td class="category_hidden_2">
                                    {{ __('more_details') }}
                                </td>
                                <td class="category_hidden_2">
                                    <div style="" >
                                        ...
                                        <div class="radio w3-cell radios"  >
                                            ...
                                            <label  for="furnished" class="radio-label">{{ __('furnished') }}</label>
                                        </div>

                                        <div class="radio w3-cell radios"  >
                                            <input  id="has_parking" name="has_parking" v-model="post.has_parking" type="checkbox">
                                            <label  for="has_parking" class="radio-label">{{ __('has_parking') }}</label>
                                        </div>

                                        <div class="radio w3-cell radios"  >
                                            <input  id="has_garden" name="has_garden" v-model="post.has_garden" type="checkbox">
                                            <label  for="has_garden" class="radio-label">{{ __('has_garden') }}</label>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3" >
                                    <textarea class="form-control input-sm" style="resize: vertical;" v-model="post.description"  placeholder="{{ __('description') }}"></textarea>
                                </td>
                            </tr>
                                    ...
                                    <div style="" >
                                      <div class="radio w3-cell" onclick="app.post.finishing_type='extra_super_lux'" >
                                       ...
                                       <div class="radio w3-cell" onclick="app.post.finishing_type='super_lux'" >
                                        ...
                                        <label  for="semi_finished" class="radio-label">{{ __('semi_finished') }}</label>
                                      </div>
                                        <div class="radio w3-cell" onclick="app.post.finishing_type='core&chel'" >
                                        <input  id="core&chel" name="finishing_type" type="radio">
                                        <label  for="core&chel" class="radio-label">{{ __('core&chel') }}</label>
                                      </div>
                                        ...
                                        <label  for="without_finished" class="radio-label">{{ __('without_finished') }}</label>
                                      </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <center>
                                <button
                                    class="w3-btn w3-padding w3-round-xxlarge w3-large light-theme-background  animated fadeInRight"
                                    style="width: 200px;border: 1px solid #02A2A7;"
                                    onclick="savePost()" >
                                        @if(request()->post_id)
                                        {{ __('edit') }}
                                ...
                                <button
                                    class="w3-btn w3-padding w3-round-xxlarge w3-large  animated fadeInLeft fa fa-angle-left"
                                    style="width: 200px;border: 1px solid #02A2A7;"
                                    onclick="gotoStep2(2)" > {{ __("back") }} </button>
                            </center>
                        </div>
                    </div>
                    <br>
...
async defer></script>
<script>
var login_first = '{{ __("login_first") }}';
var masterImageError = '{{ __("upload_master_photo") }}';
var image_error = '{{ __("upload_some_images") }}';
var choose_location = '{{ __("choose_location") }}';
var fill_all_data = '{{ __("fill_all_data") }}';
var fill_required_data_msg  = '{{ __("fill_all_data") }}';
var imageAdded = '{{ __("image_add_to_list") }}';
var app = {};
var step = 1;
